  ...
  return (
    <div className="relative -z-0 flex w-full items-center justify-center overflow-clip">
      <div className="flex max-w-screen-2xl flex-col gap-4 p-4 sm:p-12">
        {/* Header */}
        <h1 className="text-center text-[clamp(2rem,0.235rem+9.412vw,4rem)] font-bold leading-none sm:text-left">
          The Best Place To <br /> Find And Buy <br /> The Latest Games
        </h1>

        {/* Secondary Text */}
        <p className="flex-wrap text-center text-base sm:max-w-[60%] sm:text-left">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Odit beatae tempore excepturi quis non eligendi
          autem culpa
        </p>

        {/* Button */}
        <Link to="/store" className="btn-primary btn m-auto w-max sm:m-0">
          Explore Now
        </Link>

        {/* Styled circles */}
        <div className="absolute -left-1/2 -top-[15%] -z-10 aspect-square w-[80%] rounded-full bg-secondary"></div>
